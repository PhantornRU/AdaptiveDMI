...
using AdaptiveDMI.Activation;
using AdaptiveDMI.Contracts.Activation;
...
using AdaptiveDMI.Models;
using AdaptiveDMI.Services;
using AdaptiveDMI.ViewModels;
using AdaptiveDMI.Views;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddTransient<ProcessPage>();
